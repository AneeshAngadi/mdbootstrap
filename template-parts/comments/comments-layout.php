        ...
        switch ( $comment->comment_type ) :
            ...
            case 'trackback' :
                ...
                default :
                    ...
                    ?>
                <div class="media d-flex mt-3" <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
                        <?php if($comment->user_id) { ?>

                                    <?php
                                    echo get_avatar( $comment, 50, $default, $alt, array( 'class' => array( 'd-flex', 'mb-3', 'me-3', 'shadow-1-strong', 'rounded' ) ) );
                                    ?>

                        <?php } else { ?>
                            <span>
                                    <?php echo get_avatar( $comment, 50, $default, $alt, array( 'class' => array( 'd-flex', 'mb-3', 'me-3', 'shadow-1-strong', 'rounded' ) )); ?>
                            </span>
                        <?php } ?>
                            <div class="media-body me-md-3 me-0">
                            ...
                            <div>
                            <i class="far fa-clock"></i> <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>"><time pubdate datetime="<?php comment_time( 'c' ); ?>">
                                <?php
