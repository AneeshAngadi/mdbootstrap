                                    ...
                                    <?php endif; ?>
                                       ...
                                       $args = array(
                                        ...
                                        'comment_field' => (is_user_logged_in() ? '
                                                            ...
                                                            <div class="row gy-3">
                                                                <!--Image column-->
                                                                <div class="col-sm-2 col-xs-12 text-center align-self-center">' .
                                                                    get_avatar( get_current_user_id(), 100, $default, $alt, array( 'class' => array( 'shadow-1-strong', 'rounded', 'w-100', 'h-auto' ) ) ) .
                                                                '</div>
                                                                <!--/.Image column-->
                                           ...
                                           'logged_in_as' => '<p>('. sprintf(
                                            ...
                                            'title_reply' => '',
                                            'class_submit' => 'btn btn-info btn-md mt-3 d-block mx-auto',
                                            'label_submit' => 'post '
